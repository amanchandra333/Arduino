...
int f_upper= 410;
int f_lower= 330;
int wx_middle_upper= 385;
int wx_middle_lower= 340;
int wx_upper= 410;
int wx_lower= 335;
...
void loop()
{
  ...
  else if(awx>wx_middle_lower && awx<wx_middle_upper && awy>=wy_upper)
  {
    //left
    digitalWrite(winput1, LOW);
    digitalWrite(winput2, HIGH);
  ...
  else if(awx>wx_middle_lower && awx<wx_middle_upper && awy<=wy_lower)
  {
    //right
    digitalWrite(winput1, HIGH);
    digitalWrite(winput2, LOW);
